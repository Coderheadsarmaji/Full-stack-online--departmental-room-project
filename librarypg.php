...
<body>
    ...
    <section class="notice">
        ...
        <div> 
            <form action="uploadpg.php" method="post" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn" name="upload1"><span></span>UPLOAD</button>
            </form>
        </div>
    </section>
