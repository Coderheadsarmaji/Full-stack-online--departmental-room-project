    ...
    <style type="text/css">
        *{
        ...
        .header{
            min-height: 50vh;
            width: 100%;
            background-image: /*linear-gradient(rgba(4,9,30,.1),rgba(4,9,30,.7)),*/url(image/quotes.jpg); 
...
<body>
    ...
    <center><h3>UPDATE QUOTE</h3></center>
    <br>
    <div>
    <form action="quotes_submit.php" method="post">
    <div class="form-group">
    <label>ID :</label>
    <input type="text" class="form-control" name="submitid" placeholder="Enter ID">
    </div>
    <div class="form-group">
    <label>QUOTES :</label>
    <textarea name="quotes" rows="8" cols="80" class="form-control1" placeholder="Type new one...."></textarea>
    </div>
